declare global {
  ...
  const connectDB: typeof import('../../server/utils/mongoose').connectDB
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from 'C:/workspace/practice/Vue/practice1/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from 'C:/workspace/practice/Vue/practice1/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { generateToken, verifyToken } from 'C:/workspace/practice/Vue/practice1/server/utils/jwt';
export { connectDB } from 'C:/workspace/practice/Vue/practice1/server/utils/mongoose';